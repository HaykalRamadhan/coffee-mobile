...
const styles = StyleSheet.create({
  ...
  input: { minHeight: 50, borderRadius: 15, backgroundColor: "#F3F5F4", borderWidth: 1, borderColor: "#DDE3DF", color: COLORS.ink, fontSize: 12, fontWeight: "600", paddingHorizontal: 14, marginBottom: 15 },
  noteInput: { minHeight: 84, paddingTop: 13, textAlignVertical: "top", marginBottom: 0 },
  paymentCard: { flexDirection: "row", alignItems: "center", backgroundColor: "#F1F4F2", borderRadius: 21, padding: 15, marginBottom: 13 },
