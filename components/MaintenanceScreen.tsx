...
const styles = StyleSheet.create({
  ...
  content: { flex: 1, paddingHorizontal: 22, paddingTop: 20, paddingBottom: 28 },
  brandRow: { flexDirection: "row", alignItems: "center", alignSelf: "center", gap: 11, zIndex: 2 },
  logoMark: { width: 44, height: 44, borderRadius: 15, backgroundColor: COLORS.yellow, alignItems: "center", justifyContent: "center", transform: [{ rotate: "-4deg" }] },
  logoBolt: { color: COLORS.green, fontSize: 33, lineHeight: 36, fontWeight: "900" },
  logo: { color: COLORS.ink, fontSize: 26, fontWeight: "900", fontStyle: "italic", letterSpacing: -1.5 },
  logoLine: { color: COLORS.muted, fontSize: 7.5, fontWeight: "900", letterSpacing: 1.8, marginTop: 1 },
  maintenanceCard: { flex: 1, maxHeight: 570, width: "100%", maxWidth: 430, alignSelf: "center", justifyContent: "center", backgroundColor: COLORS.ink, borderRadius: 32, paddingHorizontal: 25, paddingVertical: 28, marginTop: 28, shadowColor: "#071B14", shadowOpacity: 0.36, shadowOffset: { width: 0, height: 14 }, shadowRadius: 20, elevation: 12 },
  maintenanceCardCompact: { paddingHorizontal: 20, paddingVertical: 22, marginTop: 20 },
  iconBurst: { width: 116, height: 116, borderRadius: 39, backgroundColor: COLORS.yellow, alignItems: "center", justifyContent: "center", alignSelf: "center", marginBottom: 24, transform: [{ rotate: "-3deg" }] },
  ...
  statusText: { color: COLORS.yellow, fontSize: 8, fontWeight: "900", letterSpacing: 1.2 },
  ...
  message: { color: "#CBD4CA", fontSize: 11, lineHeight: 18, textAlign: "center", maxWidth: 330, alignSelf: "center", marginTop: 15 },
  ...
  footerCopy: { flex: 1 },
  footerTitle: { color: COLORS.yellow, fontSize: 10.5, fontWeight: "900" },
  footerText: { color: "#AEBBAF", fontSize: 8, lineHeight: 12, marginTop: 3 },
